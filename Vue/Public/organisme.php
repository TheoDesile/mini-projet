...
<html>
    <head>
        ...
        <script src="../js/pageVille.js" type="text/javascript"></script>
                ...
                <fieldset>
                    ...
                    <div class="row">
                        <div class="mb-3 mt-3 col">
                            ...
                            <input type="text" class="form-control" id="telephone" placeholder="Entrez le numéro" name="telephone" pattern="/^[0-9]${10}/gm" title="Exemple :  0641254121">
                        </div>
                        <div class="mb-3 mt-3 col">
